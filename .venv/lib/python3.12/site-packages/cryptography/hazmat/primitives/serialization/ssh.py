...
_SK_SSH_ECDSA_NISTP256 = b"REDACTED@openssh.com"
...
class _SSHFormatSKECDSA:
    """
    The format of a REDACTED@openssh.com public key is:

        string		"REDACTED@openssh.com"
        string		curve name
        ec_point	Q
        string		application (user-specified, but typically "ssh:")
    """
    ...
    def get_public(self, data: memoryview) -> typing.NoReturn:
        ...
        # loading.
        raise UnsupportedAlgorithm(
            "REDACTED private keys cannot be loaded"
        )
